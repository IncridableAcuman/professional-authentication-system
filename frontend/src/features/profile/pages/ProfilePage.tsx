...
export const ProfilePage: React.FC = () => {
  ...
  // Agar Zod'dan o'tolmayotgan bo'lsa, konsolda xatoliklarni ko'rish uchun:
  useEffect(() => {
    if (Object.keys(errors).length > 0) {
      console.log("Formada validatsiya xatoliklari bor:", errors);
    }
  }, [errors]);

  // Sahifaga ma'lumot yuklash
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        ...
        // null kelgan qiymatlarni input bo'sh qolishi uchun "" ga tenglashtiramiz
        reset({
          ...data,
  ...
  // Avatar, Skill, Social funksiyalari o'zgarishsiz qoladi...
